...
# Abnormal camera operation information
...
# Camera device information, read-only information, please do not modify
...
# Description information of camera white balance mode
...
# Transmission packet size description (mainly valid for network cameras)
...
# Enable information of the ISP module
...
# Asynchronous screenshot completion callback
...
# Callback for collector image capture
